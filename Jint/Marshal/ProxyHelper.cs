...
namespace Jint.Marshal {
    ...
    class ProxyHelper {
        ...
        public JsMethodImpl WrapMethod(MethodInfo info, bool passGlobal) {
            ...
            DynamicMethod jsWrapper = new DynamicMethod("jsWrapper", typeof(JsInstance), new Type[] { typeof(IGlobal), typeof(JsInstance), typeof(JsInstance[]) });
        ...
        public ConstructorImpl WrapConstructor(ConstructorInfo info, bool passGlobal) {
            ...
            DynamicMethod dm = new DynamicMethod("clrConstructor", typeof(object), new Type[] { typeof(IGlobal), typeof(JsInstance[]) });
        ...
        public JsGetter WrapGetProperty(PropertyInfo prop, Marshaller marshaller) {
            ...
            if (dm == null) {
                dm = new DynamicMethod("dynamicPropertyGetter", typeof(JsInstance), new Type[] { typeof(Marshaller), typeof(JsDictionaryObject) });
        ...
        public JsGetter WrapGetField(FieldInfo field, Marshaller marshaller) {
            ...
            if (dm == null) {
                dm = new DynamicMethod("dynamicFieldGetter", typeof(JsInstance), new Type[] { typeof(Marshaller), typeof(JsDictionaryObject) });
                var code = dm.GetILGenerator();
        ...
        public JsSetter WrapSetProperty(PropertyInfo prop, Marshaller marshaller) {
            ...
            if (dm == null) {
                dm = new DynamicMethod("dynamicPropertySetter", null, new Type[] { typeof(Marshaller), typeof(JsDictionaryObject), typeof(JsInstance) });
        ...
        public JsIndexerGetter WrapIndexerGetter(MethodInfo getMethod, Marshaller marshaller) {
            ...
            if (dm == null) {
                ...
                dm = new DynamicMethod("dynamicIndexerSetter", typeof(JsInstance), new Type[] { typeof(Marshaller), typeof(JsInstance), typeof(JsInstance) });
