...
namespace System
{
    public static class EnumX
    {
        ...
        {
            if (!t.IsEnum) throw new ArgumentException(); // todo, make message nicer
        ...
        public static object[] GetValues(Type t)
        {
            if (!t.IsEnum) throw new ArgumentException(); // todo, make message nicer
...
{
    public class SortedList<T, K> : Dictionary<T, K>
    {
        public SortedList()
        {
        }

        public SortedList(SortedList<T, K> proto)
        {
...
namespace System
{
    ...
    {
        internal void AddPermission(IPermission perm)
        {
